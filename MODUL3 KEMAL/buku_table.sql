...
(18, 'Kalkulus Lanjut', 'Kemal_1202190343', 2021, 'Buku ini kelanjutan dari kalkulus dasar', 'Array', 'Kalkulus', 'Indonesia');
...
--
ALTER TABLE `buku_table`
  MODIFY `id_buku` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
